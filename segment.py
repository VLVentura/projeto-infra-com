...
class Packet:
    ...
    def compose(self) -> None:
        ...
        self.segment.append(self.data)
        self.segment.append(self.length)
        self.segment.append(self.src_port)
        self.segment.append(self.dest_port)
        self.segment.append(self.checksum)
