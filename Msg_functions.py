...
def __cut_msg(byte_msg):        #Input: mensagem no formato de byte
    """ Split segmento em Payload e dados"""
    global PAYLOAD
...
def __unpack_helper(msg):
    """ Destrincha a menssagem recebida"""
    global MSG_FORMAT
...
def __has_seq(recv_msg, seq_num):
    """ Checa se pacote recebido contem o sequence equivalente ao sequence esperado"""
